...
# %%
# main
filename_input1 = 'J:\\output\\prob_season_0811\\global\\global_prec_seas.npy'  # Seasonal average precipitation file
season_prec = np.load(filename_input1)
filename_input2 = 'J:\\output\\main charc_add rand\\max_serious_global.npy'  # the most serious drought
...
for num in range(420):
    for phase in ['his','pres']:
        ...
        # load data
        filename_input3 = 'J:\\output\\main charc_add rand\\' + phase + '_reslice\\' + phase + '_' + str(num) + '.npy'
        print(phase, num)
        ...
        pro_file_climatology, pro_file_sce, lat_lon_cal = sim_prob(data_charc, max_serious_global, season_prec, num,
                                                                   phase)
        # save data
        filename_output1 = 'J:\\output\\prob_season_0811\\grid_' + phase + '\\lat_lon_' + phase + '_' + str(
            num) + '.npy'
        filename_output2 = 'J:\\output\\prob_season_0811\\clima_' + phase + '\\prob_clima_' + phase + '_' + str(
            num) + '.npy'
        filename_output3 = 'J:\\output\\prob_season_0811\\sce_' + phase + '\\prob_sce_' + phase + '_' + str(
            num) + '.npy'
